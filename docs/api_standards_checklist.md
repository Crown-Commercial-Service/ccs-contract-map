...
| **Use caching**                           | **N/A**         | FastAPI post method is used to get AI model to label contract, however using GET method to get caching will be used for caching identical contract descriptions to reduce AI processing costs.         |
| **Use caching**                           | **N/A**         | FastAPI post method is used to get AI model to label contract, however using GET method to get caching will be used for caching identical contract descriptions to reduce AI processing costs.         |
